...
import { createFakeBankAccountController, createUser, getUsers } from "../controllers/user.controller.js";
...
userRouter.post('/fake-bank-account', protect, authorizeRoles('ADMIN'),CreateFakeBankRequestValidation,handleValidationError,createFakeBankAccountController)
