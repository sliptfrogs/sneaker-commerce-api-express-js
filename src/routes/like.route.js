...
import { createLikeController, destroyLikeController, getLikesController, updateLikeController } from "../controllers/like.controller.js";
...
likeRoute.post('/',likeMiddlewareValidate,handleValidationError,createLikeController)
